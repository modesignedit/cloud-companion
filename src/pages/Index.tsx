 ...
 * Features city search, temperature display, unit toggle, and dynamic backgrounds
 */
const Index = () => {
  ...
  return (
    // Dynamic background changes based on weather condition code
    <WeatherBackground conditionCode={weather?.conditionCode ?? null}>
      <main>
